...
QT_MOC_LITERAL(1, 6, 11), // "signalStart"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 21) // "on_buttonBox_accepted"

    },
    "Start\0signalStart\0\0on_buttonBox_accepted"
};
...
void Start::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Start::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Start::signalStart)) {
                *result = 0;
                return;
            }
        }
